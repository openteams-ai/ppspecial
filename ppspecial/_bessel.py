...
def _j0_asymp(ax: f64) -> f64:
    """sqrt(2/(π·ax))·(P₀·cos(ax-π/4) - Q₀·z·sin(ax-π/4)), z = 8/ax."""
    two_over_pi: f64 = 0.6366197723675814
    pi_over_4: f64 = 0.7853981633974483
    z: f64 = 8.0 / ax
    y: f64 = z * z
    xx: f64 = ax - pi_over_4
    p0: f64 = 0.2093887211e-6
    p0 = p0 * y - 0.2073370639e-5
    p0 = p0 * y + 0.2734510407e-4
    p0 = p0 * y - 0.1098628627e-2
    p0 = p0 * y + 1.0
    q0: f64 = -0.934945152e-7
...
def _j1_asymp(ax: f64) -> f64:
    """Asymptotic J₁ / Y₁ common auxiliary functions for |x| > 8."""
    two_over_pi: f64 = 0.6366197723675814
    pi3_over_4: f64 = 2.356194490192345
    z: f64 = 8.0 / ax
    y: f64 = z * z
    xx: f64 = ax - pi3_over_4
    p1: f64 = -0.240337019e-6
    p1 = p1 * y + 0.2457520174e-5
    p1 = p1 * y - 0.3516396496e-4
    p1 = p1 * y + 0.183105e-2
    p1 = p1 * y + 1.0
    q1: f64 = 0.105787412e-6
