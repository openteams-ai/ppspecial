...
def _ndtri_rational(p: f64) -> f64:
    ...
    a0: f64 = -3.969683028665376e+01
    a1: f64 =  2.209460984245205e+02
    a2: f64 = -2.759285104469687e+02
    a3: f64 =  1.383577518672690e+02
    a4: f64 = -3.066479806614716e+01
    a5: f64 =  2.506628277459239e+00

    b0: f64 = -5.447609879822406e+01
    b1: f64 =  1.615858368580409e+02
    b2: f64 = -1.556989798598866e+02
    b3: f64 =  6.680131188771972e+01
    b4: f64 = -1.328068155288572e+01

    # Tail region coefficients (p near 0 or 1)
    c0: f64 = -7.784894002430293e-03
    c1: f64 = -3.223964580411365e-01
    c2: f64 = -2.400758277161838e+00
    c3: f64 = -2.549732539343734e+00
    c4: f64 =  4.374664141464968e+00
    c5: f64 =  2.938163982698783e+00

    d0: f64 =  7.784695709041462e-03
    d1: f64 =  3.224671290700398e-01
    d2: f64 =  2.445134137142996e+00
    d3: f64 =  3.754408661907416e+00

    p_low:  f64 = 0.02425
    p_high: f64 = 1.0 - 0.02425
...
def erfinv(x: f64) -> f64:
    ...
    p: f64 = (x + 1.0) * 0.5
    w: f64 = _ndtri_rational(p)
    result: f64 = w * 0.7071067811865475   # / sqrt(2)
    ...
    err: f64 = erf(result) - x
    deriv: f64 = 1.1283791670955126 * exp(-result * result)   # 2/sqrt(pi)
    result = result - err / (deriv + result * err)
    return result


@vectorize
def erfcinv(x: f64) -> f64:
